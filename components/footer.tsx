          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 mb-12">
            <div>
              ...
              <p className="text-gray-400 mb-6 text-sm leading-relaxed">
                Full-Stack Developer & Founder of OmiChain. Building innovative digital solutions with modern web technologies.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400 text-sm">
                ...
                <li>
                  <a href="http://omichain.org/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                    Visit OmiChain
                  </a>
                </li>
              </ul>
